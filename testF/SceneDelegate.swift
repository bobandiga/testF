...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let filtersVC = UIStoryboard(name: "Filters", bundle: nil).instantiateViewController(identifier: "FiltersViewController") as! FiltersViewController
        ...
        navC.viewControllers = [filtersVC,mainVC]
